    ...
    return (
        <div className="carousel w-full sm:hidden  ">
            <div id="slide1" className="carousel-item relative hero w-full">
                <div className="hero min-h-[500px]" style={{ backgroundImage: 'url(https://i.ibb.co/ySGkXwm/Chat-with-Lex-Ai.jpg)' }}>
                    ...
                    <div className=" w-full   flex gap-20">
                        <div className="w-1/2 flex justify-center items-center">
                            <div className="flex flex-col items-center justify-center mt-16">
                                ...
                                <h1 className="text-center text-3xl font-['Open_Sans'] font-semibold text-white mt-10 ">Chat with Lex.Ai </h1>
                                <Link to="/Lex-Ai">
            ...
            <div id="slide2" className="carousel-item relative hero w-full">
                <div className="hero min-h-[500px]" style={{ backgroundImage: 'url(https://i.ibb.co/RydTJMS/blurred-lawyer.jpg)' }}>
                    <div className="hero-overlay bg-opacity-60"></div>
                    ...
                    <div className="w-1/2 flex justify-center items-center">
                        <div className="flex flex-col items-center justify-center mt-16">
                            ...
                            <h1 className="text-center text-3xl font-['Open_Sans'] font-semibold text-white mt-10 ">Appoint a lawyer  </h1>
                            <Link to="/appointment">
